...
import datetime
from psychopy import locale_setup, visual, core, data, event, logging, sound, gui, useVersion
...
expInfo = {u'mriMode': u'Off', u'sessionID': u'', u'counterbalance': u'practice',}
...
if trigger == 'parallel':
    ...
    MR_settings = { 
        ...
        'sync': config['trigger'], # character to use as the sync timing event; assumed to come at start of a volume
